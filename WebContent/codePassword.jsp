...
<body>
	...
	<div class="col-lg-3"></div>
		<div class="col-lg-6">
			<form action="codePassword" method="post">
				<br>
				<!--<s:textfield label="Given Code" name="code" readonly="true" cssClass="form-control"/>-->
				<s:textfield label="Code" name="userCode" placeholder="Code" cssClass="form-control"/>
